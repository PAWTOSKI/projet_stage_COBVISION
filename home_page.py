    ...
    [
       dbc.Row(
           [
               dbc.Col(
                  [
                     html.H2("Cobtest: outil d'évaluation "),
                     html.P(
                         """\
Bienvenue sur l'application Cobtest. Pour bénéficier de ces services, veuillez vous inscrire via la création d'un compte utilisateur.
...
afin de délivrer le champ adéquat de vue, tout en garantissant l'anonymisation des participants et des usagers """
                           ),
